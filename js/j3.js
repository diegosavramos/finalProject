...
Use a keyword to declare the variable, then provide a varaible name of your choice. 
Then properly use JS to GET THE ELEMENT with the ID of quote. Hint: the format for 
completing this step should looking like:
...
var firstVar = document.getElementById ('quote');
...
firstVar.classList.add('animate__animated', 'animate__backInRight', 'animate__slower');

/*
Step 3: Add console log statement to the end of this script.
You simply want to write a statement the console log of the browser. The statement can be anything, e.g., "animation completed". 
You will need to determine how to add the console log command with your statement.
*/
...
/*
hint: you will need when your JS code is correct when you receive no errors in the console log. 
If you receive a syntax error in the console log when loading the learntargetj3.html page, then try to troubleshoot and resolve the error.
*/